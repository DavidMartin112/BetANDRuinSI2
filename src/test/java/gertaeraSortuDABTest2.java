...
public class gertaeraSortuDABTest2 {
		...
		/*
		 * @Test //The sport is not in the database public void test1() { //define
		 * paramaters String sport="F1"; Date date= UtilDate.newDate(2022,10,9); String
		 * description= "Japan GP";
		 * 
		 ...
		 * 
		 * //invoke System Under Test (sut) try { result=sut.gertaerakSortu(description,
		 * date, sport);
		 * 
		 * } catch(Exception e) { e.printStackTrace(); fail(); } //verify the results
		 * assertTrue(!result);
		 * 
		 * }
		 */
